...
<script setup lang="ts">
	...
	import HoursInput from "@/components/donor/HoursInput.vue";

	const { tempTime, tempId, tempDate, formattedDate, freeHours } =
		storeToRefs(useAppointmentsStore());
	const { fetchFreeHours } = useAppointmentsStore();

	watch(tempDate, (value: any) => {
